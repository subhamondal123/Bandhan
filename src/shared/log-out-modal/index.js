                    ...
                    <React.Fragment>
                        <View style={styles.modalHeaderSec}>
                            <View style={styles.crossImgSec}>
                                <Image source={ImageName.SHUT_DOWN_LOGO} style={styles.redCrossImg} />
                            </View>
                        </View>
                        {isLoading ?
                            ...
                            >
                                <View style={styles.modalMainMarginSec}>
                                    ...
                                    <View style={{ flexDirection: 'row', marginTop: '10%', justifyContent: 'center', alignContent: 'center', marginRight: '15%', marginLeft: '15%' }}>
