...
export function validateData(data) {
    ...
    else if (data.brandId == undefined || data.brandId == null || data.brandId == "0") {
        Toaster.ShortCenterToaster("Please select Brand!");
        errCounter++;
    }
    ...
    else if (data.stateId == undefined || data.stateId == null) {
        Toaster.ShortCenterToaster(AlertMessage.MESSAGE.CREATE_ENQUIRY.SOURCE_INFO.STATE_ERROR);
        errCounter++;
    } else if (data.districtId == undefined || data.districtId == null) {
        Toaster.ShortCenterToaster(AlertMessage.MESSAGE.CREATE_ENQUIRY.SOURCE_INFO.DISTRICT_ERROR);
        errCounter++;
    } else if (data.zoneId == undefined || data.zoneId == null) {
        Toaster.ShortCenterToaster(AlertMessage.MESSAGE.CREATE_ENQUIRY.SOURCE_INFO.ZONE_ERROR);
        errCounter++;
    }
    else if (data.cityVillage == undefined || data.cityVillage == null || data.cityVillage.length == 0) {
        Toaster.ShortCenterToaster("Please enter City/ Village!");
        errCounter++;
    }
    ...
    else if (data.notes == undefined || data.notes == null || data.notes.length == 0) {
        Toaster.ShortCenterToaster("Please enter Notes!");
        errCounter++;
    }
