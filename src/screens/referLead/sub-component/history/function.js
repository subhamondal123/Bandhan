        ...
        if (enquiryData && enquiryData.length > 0) {
            for (let i = 0; i < enquiryData.length; i++) {
                ...
                if (enquiryData[i].enqueryTitle == undefined || enquiryData[i].enqueryTitle == null) {
                    ...
                    modObj["enqueryTitle"] = nameCheck(enquiryData[i].enqueryTitle);
                }
                ...
                if (enquiryData[i].isConverted == undefined || enquiryData[i].isConverted == null) {
                    modObj["isConverted"] = "";
                } else {
                    modObj["isConverted"] = enquiryData[i].isConverted;
                }
                if (enquiryData[i].createdDate == undefined || enquiryData[i].createdDate == null) {
                    modObj["createdDate"] = "";
                } else {
                    modObj["createdDate"] = enquiryData[i].createdDate;
                }
                if (enquiryData[i].approveMessage == undefined || enquiryData[i].approveMessage == null) {
                    modObj["approveMessage"] = "";
                } else {
                    modObj["approveMessage"] = enquiryData[i].approveMessage;
                }
                if (enquiryData[i].leadType == undefined || enquiryData[i].leadType == null) {
                    modObj["leadType"] = "";
                } else {
                    modObj["leadType"] = enquiryData[i].leadType;
                }
                if (enquiryData[i].visitStatus == undefined || enquiryData[i].visitStatus == null) {
                    modObj["visitStatus"] = "";
                } else {
                    modObj["visitStatus"] = enquiryData[i].visitStatus;
                }
...
function nameCheck(enqueryTitle) {
    enqueryTitle = enqueryTitle.trim();

    if (enqueryTitle.endsWith("null")) {
        enqueryTitle = enqueryTitle.substring(0, enqueryTitle.length - 5).trim();
    }
