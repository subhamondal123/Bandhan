...
// fill={data.map((obj) => obj.symbol.fill)}
...
//     return (
//       <Rect x={x - 5} y={y - 5} width={15} height={15} fill={data.map((obj) => obj.symbol.fill)} rx={5}
//       ry={5}/> // A function that returns a React element
//     );
//   };
